...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/x1s/prebuilt/kernel
TARGET_PREBUILT_DTB := device/samsung/x1s/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/x1s/prebuilt/recovery_dtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/x1s/bootimg.mk
